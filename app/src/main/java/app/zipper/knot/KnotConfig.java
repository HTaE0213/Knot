...
public class KnotConfig {
  ...
  public final Item hideIncomingImages           = item("hide_incoming_images",             R.string.opt_hide_incoming_images_label,             R.string.opt_hide_incoming_images_desc,             false, Category.CHAT,         R.string.sec_chat_media);
